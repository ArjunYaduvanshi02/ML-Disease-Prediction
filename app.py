...
def process_option():
    selected_opt1 = request.form['selected_option1']
    selected_opt2 = request.form['selected_option2']
    selected_opt3 = request.form['selected_option3']
    selected_opt4 = request.form['selected_option4']
    selected_opt5 = request.form['selected_option5']

    print(f'You selected: {selected_opt1} {selected_opt2} {selected_opt3} {selected_opt4} {selected_opt5}')
...
def register():
    ...
    def plotScatterMatrix(df1, plotSize, textSize):
        ...
        df1 = df1[
            [col for col in df if df[col].nunique() > 1]]  # keep columns where there are more than 1 unique values
        columnNames = list(df)
    ...
    def rand_for(sy1, sy2, sy3, sy4, sy5):
        ...
        c.close()
        conn.close()
        print("ye h beemari:", pred2.get())


    if request.method=="POST":
        sy1=request.form['username']
        sy2=request.form['phone']
        sy3=request.form['gender']
        sy4=request.form['blood']
        sy5=request.form['email']
        print(sy1,sy2,sy3,sy4,sy5)

        print(Destree(sy1, sy2, sy3, sy4, sy5),rand_for(sy1, sy2, sy3, sy4, sy5),knn_knn(sy1, sy2, sy3, sy4, sy5),bayes(sy1, sy2, sy3, sy4, sy5))
        return render_template('register.html', result_destree="DECISION TREE: "+Destree(sy1, sy2, sy3, sy4, sy5), result_rand_for="RANDOM FOREST: "+rand_for(sy1, sy2, sy3, sy4, sy5),
                               result_knn="KNN ALGORITHM: "+knn_knn(sy1, sy2, sy3, sy4, sy5), result_bayes="NAIVE BAYES: "+bayes(sy1, sy2, sy3, sy4, sy5))
    return render_template('register.html')
